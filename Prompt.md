...
현재 프로젝트를 다른 프로젝트에서 쓸수있도록 하나의 html 페이지로 export 하거나, css, html, js 각각 구성해서 프로젝트에
  적용해야해. 어떤 방식으로 해야 할지 조사해서 알려줘 ultracode


### 12. 2026-06-19
 한장으로 export 하는 스크립트를 만들어서 외부 프로젝트에서도 사용할 수 있도록 해주고, js, css, html 이 하나의 경로에 있어서
  참조시 깨지지 않도록 해. 그대로 복사해서 프로젝트에 넣은뒤 사용할거야